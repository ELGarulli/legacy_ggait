function [primo_frame,num_frame,num_markers,frequenza,F,M,CP,coord1,mkr,MarkerName]=load_VICON_c3d(nome_file,force)
...
if fid<0, msgbox('ERROR when opening the .c3d file!','Load_VICON_c3d','error'), return, end;
...
if fattore_scala>0, disp('I dati sono registrati come interi e bisogna riscalarli'); end;
...
else num_chan=analog_per_frame/analog_sample_frame;
end
...
% Header
if ultimo_frame>0, num_frame=ultimo_frame-primo_frame+1; end
